...
<!-- Login modal -->
    ...
    <div class="breadcrumbs">
        <div class="container">
            <ol>
                ...
                <li><a href="<?php echo base_url(); ?>index.php/topics">Pages</a>
                </li>
    ...
    <div class="content-wrapper">
        <div class="container">
            ...
            <?php $this->load->view($contentdata); ?>
                
            </div>
        </div>

        <?php $this->view('content/view_feedback'); ?>

        <!--<?php $this->view('content/view_comment'); ?>-->
